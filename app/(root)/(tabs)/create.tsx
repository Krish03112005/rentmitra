...
interface FormState {
  ...
  longitude: string;
  isFeatured: boolean;
  images: string[]; //Supabase storage public URL's -> saved to DB
  localImages: string[]; // Device URI's -> shown in preview only 
}
...
export default function Create() {
  ...
  const handlePickImages = async () => {
    ...
    if (!permission.granted) {
      Alert.alert (
        "Permission Required",
        "Please allow acess to your photo library.",
      );
